...
$lang['step_one_title'] = 'Choisissez une session et un service';
$lang['select_service'] = 'Choisissez une session';
$lang['select_provider'] = 'Choisissez un service';
$lang['duration'] = 'Durée';
...
$lang['notes'] = 'Informations sur la formation de l\'inscription *';
...
$lang['thank_you_for_appointment'] = 'Merci de votre prise de rendez-vous avec nous. Vous trouvez ci-joint les détails de votre rendez-vous. Si nécessaire, faites les changements souhaités en cliquant sur le lien du rendez-vous. \<p\>Quel que soit le lieu du département d’enseignement auquel vous serez rattaché, (Valbonne Sophia Antipolis, Cannes, Menton ou Nice), votre inscription administrative sera réalisée à l\'IUT de Nice au : SERVICE DE LA SCOLARITE 41 BOULEVARD NAPOLEON III 06206 NICE CEDEX 03';
$lang['appointment_details_title'] = 'Détails du rendez-vous';
$lang['customer_details_title'] = 'Vos informations';
$lang['service'] = 'Sessions';
$lang['provider'] = 'Service';
$lang['customer'] = 'Candidat';
$lang['start'] = 'Début';
$lang['end'] = 'Fin';
$lang['name'] = 'Nom';
$lang['phone'] = 'Numéro de téléphone';
$lang['address'] = 'Adresse';
$lang['appointment_link_title'] = 'Lien du rendez-vous pour le modifier ou le supprimer';
$lang['success'] = 'Réussi !';
...
$lang['manage_appointment_record_hint'] = 'Gérer tous les enregistrements de rendez-vous des services et des sessions actives.';
$lang['select_filter_item_hint'] = 'Choisisez un service ou une session et visualisez les rendez-vous sur l\'agenda.';
$lang['enable_appointment_sync_hint'] = 'Activez la synchronisation des rendez-vous avec le calendrier Google du Service.';
$lang['manage_customers_hint'] = 'Gérer les candidats enregistés et voir leur historique de rendez-vous.';
$lang['manage_services_hint'] = 'Gérer les sessions et les catégories actives du système.';
$lang['manage_users_hint'] = 'Gérer les utilisateurs back office (administrateurs, service, personnels).';
$lang['settings_hint'] = 'Régler les paramètres système et utilisateurs.';
$lang['log_out_hint'] = 'Déconnexion du système.';
$lang['unavailable_periods_hint'] = 'Durant les périodes non disponibles le Service n\'acceptera pas de nouvelle session.';
...
$lang['select'] = 'Choisir';
$lang['hide'] = 'Cacher';
$lang['type_to_filter_customers'] = 'Filtrer les candidats.';
$lang['clear_fields_add_existing_customer_hint'] = 'Effacez tous les champs et entrez un nouveau candidat.';
$lang['pick_existing_customer_hint'] = 'Rechercher un candidat existant.';
...
$lang['providers'] = 'Services';
$lang['secretaries'] = 'Personnels';
...
$lang['provider_saved'] = 'Service enregistré avec succès !';
$lang['secretary_saved'] = 'Personnel enregistré avec succès !';
$lang['admin_deleted'] = 'Administrateur supprimé avec succès !';
$lang['provider_deleted'] = 'Service supprimé avec succès !';
$lang['secretary_deleted'] = 'Personnel supprimé avec succès !';
$lang['service_saved'] = 'Session enregistrée avec succès !';
$lang['service_category_saved'] = 'Catégorie de session enregistrée avec succés !';
$lang['service_deleted'] = 'Session supprimée avec succès !';
$lang['service_category_deleted'] = 'Catégorie de session supprimée avec succès !';
$lang['customer_saved'] = 'Candidat enregistré avec succès !';
$lang['customer_deleted'] = 'Candidat supprimé avec succès !';
...
$lang['breaks'] = 'Pauses';
$lang['add_breaks_during_each_day'] = 'Ajoutez ici les périodes de pause pour chaque jour. Pendant ces pauses le service n\'acceptera pas de rendez-vous...';
$lang['day'] = 'Jour';
$lang['days'] = 'Days';
...
$lang['go_to_booking_page'] = 'Modifier ou supprimer votre rendez-vous';
...
$lang['delete_customer'] = 'Supprimer le candidat';
$lang['delete_service'] = 'Supprimer la session';
$lang['delete_category'] = 'Supprimer la catégorie de session';
$lang['delete_provider'] = 'Supprimer un service';
$lang['delete_secretary'] = 'Supprimer un personnel';
...
$lang['require_captcha_hint'] = 'Lorsqu\'elle est activée, les candidats auront à taper un code de vérification CAPTCHA avant de pouvoir réserver / mettre à jour un rendez-vous.';
...
$lang['customer_notifications'] = 'Notifications aux candidats';
$lang['customer_notifications_hint'] = 'Définit si les candidats reçoivent des notifications par email chaque fois qu\'il y a un changement d\'horaire de l\'un de leurs rendez-vous.';
